...
// Nampilin
	...
	echo "<div class='col-md-6 col-md-offset-3'>";
			...
			echo "<form method='post' action='goleks-buyer.php'>";
	...
	echo "</table>";
	echo "<a href='purchase-buyer.php'><center><input type='button' value='Mau Beli? Klik Disini!' class='btn btn-primary' style='width:100%'></center></a>";	
	echo "<p>";
	echo "<a href='index-buyer.php'><center><input type='button' value='Klik untuk kembali' class='btn btn-primary' style='width:100%'></center></a>";	
	echo "<p>";
	echo "<br>";
