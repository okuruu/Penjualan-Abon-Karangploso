...
function dakersa() {
	...
	<form method='post' action='bons-buyer.php'>
...
<?php
	...
	echo "<a href='viewproduk-buyer.php'><center><input type='button' value='Klik untuk kembali' class='btn btn-primary' style='width:100%'></center></a>";	
	echo "<p>";
	echo "<br>";
